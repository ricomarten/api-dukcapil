...
$query_sql = "SELECT top 50 art.*,rt.alamat_rev,rt.r114_rev,
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
  ...
  if (array_key_exists("RESPONSE_CODE", $content)) {
    ...
    if (
      ...
      $sql3 = "UPDATE dbo.artregsosek
      SET cek_dukcapil=?, status_dukcapil=? WHERE
      kode_prov   =? and
      kode_kab    =? and
      kode_kec    =? and
      kode_desa   =? and
